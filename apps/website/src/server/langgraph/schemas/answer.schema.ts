import { z } from "zod";
import { ActionSuggestionSchema } from "./action-suggestion.schema";
import { CitationValidationSchema } from "./citation-validation.schema";
...
export const AskAnswerSchema = z.object({
  ...
  actionSuggestions: z.array(ActionSuggestionSchema).optional(),
  citationValidation: CitationValidationSchema.optional(),
  intent: z.string(),
});
