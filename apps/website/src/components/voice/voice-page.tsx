...
function CallRoom({
 ...
 <h3 className="text-lg font-bold text-foreground">Debo Live</h3>
...
export function VoicePage() {
 ...
 <div>
 <h1 className="text-2xl font-bold tracking-tight text-foreground">Voice Control</h1>
 ...
 <h3 className="text-sm font-semibold text-foreground">Interactive AI Voice</h3>
 ...
 <TabsTrigger value="voice-notes" className="rounded-xl text-xs py-2">
 Voice Notes
 </TabsTrigger>
 <TabsTrigger value="ai-calls" className="rounded-xl text-xs py-2">
 AI Calls
 </TabsTrigger>
 <TabsTrigger value="transcripts" className="rounded-xl text-xs py-2">
 Transcripts
 </TabsTrigger>
 </TabsList>
 ...
 <div>
 <p className="text-xs font-semibold text-foreground">{session.roomName}</p>
