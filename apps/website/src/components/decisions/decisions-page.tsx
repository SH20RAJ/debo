...
const mockDecisions: Decision[] = [
  ...
  {
    id: "3",
    title: "Use LangGraph for agent backend",
    decisionText: "LangChain and LangGraph orchestrate AI tools, memory flows, and source-backed answer generation.",
    reason: "Composable TypeScript agent graphs without shipping a heavy Worker bundle",
    status: "active",
    source: "techstack.md",
  ...
  {
    id: "4",
    title: "Use Stack Auth for product auth",
    decisionText: "Stack Auth handles product authentication while app permissions stay in website route handlers and server modules.",
    reason: "Managed auth with explicit server-side permission checks",
    status: "changed",
    source: "techstack.md",
