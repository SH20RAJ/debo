...
GET /api/mail/address
POST /api/mail/address/check
POST /api/mail/address/claim

GET /api/mail/threads
GET /api/mail/threads/:threadId
POST /api/mail/send
POST /api/mail/threads/:threadId/read
POST /api/mail/threads/:threadId/archive
DELETE /api/mail/threads/:threadId

POST /api/mail/messages/:messageId/save-to-memory
...
apps/website/src/app/mail/
  page.tsx

apps/website/src/app/api/mail/
  address/route.ts
  address/check/route.ts
  address/claim/route.ts
  threads/route.ts
  threads/[threadId]/route.ts
  send/route.ts
  messages/[messageId]/save-to-memory/route.ts

apps/website/src/components/mail/
  mail-shell.tsx
  mail-sidebar.tsx
