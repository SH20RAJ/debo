    ...
    <section id="use-cases" className="py-24 bg-background">
      <div className="container mx-auto max-w-6xl px-6">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-duo-wolf font-bold max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {useCases.map((useCase, index) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-background border-2 border-duo-swan text-duo-macaw flex items-center justify-center mb-6">
                <useCase.icon className="w-7 h-7" />
              </div>
              
              <h3 className="text-lg font-black text-duo-eel mb-6 leading-tight uppercase tracking-wider">
                "{useCase.question}"
              </h3>
              
              <div className="flex-grow space-y-6">
                <div className="p-6 rounded-[2rem] bg-duo-polar border-2 border-duo-swan shadow-inner">
                  <p className="text-sm text-duo-eel font-bold italic">
                    {useCase.answer}
                  </p>
                </div>
