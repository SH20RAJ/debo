...
export function Footer() {
  return (
    <footer className="border-t border-landing-border-light py-12 px-6 bg-landing-bg">
      <div className="container mx-auto max-w-[1120px] flex flex-col md:flex-row items-center justify-between gap-6 text-landing-sm font-medium text-landing-text-tertiary">
        <div>Debo &copy; {new Date().getFullYear()}</div>
        <div className="flex flex-wrap gap-8 justify-center">
          <Link href="/pitch" className="hover:text-landing-text-primary transition-colors">Pitch</Link>
