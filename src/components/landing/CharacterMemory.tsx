...
export function CharacterMemory() {
  return (
    <section className="border-t border-border/10 bg-muted/20 py-32">
      <div className="container mx-auto grid max-w-6xl gap-16 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div className="space-y-7">
          ...
          <div className="space-y-4">
            <h2 className="text-4xl font-heading font-semibold tracking-tight text-foreground md:text-5xl">
        ...
        <div className="rounded-2xl border border-border bg-background p-5 shadow-sm">
          <div className="flex items-center gap-4 border-b border-border/50 pb-5">
            ...
            <div>
              <div className="text-2xl font-semibold tracking-tight text-foreground">Sarah Chen</div>
          ...
          <div className="grid gap-4 pt-5 sm:grid-cols-[1fr_0.8fr]">
            ...
            <div className="space-y-2">
              {references.map((reference) => (
                <div key={reference.label} className="rounded-xl border border-border/50 bg-card p-3">
                  ...
                  <p className="mt-2 text-xs leading-relaxed text-muted-foreground">{reference.text}</p>
                </div>
              ))}
            </div>
          </div>
...
function Feature({ label }: { label: string }) {
  return (
    <div className="rounded-xl border border-border/50 bg-background px-4 py-3 text-sm font-semibold text-foreground">
      {label}
    </div>
  );
}
