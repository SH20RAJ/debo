...
export function Hero({ isSignedIn = false }: HeroProps) {
  return (
    <section className="relative bg-background dark:bg-slate-950 px-6 pt-16 pb-24 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 space-y-10 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 border-duo-macaw bg-duo-macaw/10 text-duo-macaw font-black uppercase tracking-wider text-xs">
              ...
              <span>Project Jarvis: Early Access</span>
            </div>

            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl font-heading font-black text-duo-eel dark:text-white tracking-tight leading-[1.1]">
                Your private AI memory <br />
                <span className="text-duo-feather">for everything you forget</span>
              </h1>
              <p className="text-xl text-duo-wolf dark:text-slate-400 max-w-2xl mx-auto lg:mx-0 font-bold leading-relaxed">
                Debo turns voice notes, journals, diary scans, AI chats, and calendar context into searchable memories, reminders, and evidence-backed answers about your life.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4">
              ...
              <button className="duo-btn duo-btn--secondary flex items-center justify-center gap-2 w-full sm:w-auto px-10 py-5 text-lg shadow-[0_6px_0_var(--duo-swan)]">
                <Play className="h-5 w-5 text-duo-macaw fill-duo-macaw" />
                Try example questions
              </button>
            </div>

            <div className="flex items-center justify-center lg:justify-start gap-6 text-duo-hare dark:text-slate-500 pt-2">
          ...
          <div className="flex-1 w-full max-w-2xl">
            <div className="relative rounded-[3rem] border-4 border-duo-swan bg-background dark:bg-slate-900/50 p-6 md:p-10 shadow-[0_12px_0_var(--duo-swan)] overflow-hidden">
              <div className="space-y-10">
                {/* User Input Mockup */}
                <div className="space-y-4">
                  <div className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-duo-wolf">
                    <span className="w-2.5 h-2.5 rounded-full bg-duo-fox shadow-[0_2px_0_var(--duo-fox-shadow)]" />
                    Input: Voice Note (May 10)
                  </div>
                  <div className="p-6 rounded-[2rem] bg-duo-polar dark:bg-slate-900 border-2 border-duo-swan shadow-inner italic font-bold text-duo-eel dark:text-slate-300">
                ...
                <div className="flex items-center gap-4">
                  <div className="h-1 flex-grow bg-duo-swan dark:bg-slate-800 rounded-full" />
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="p-5 rounded-2xl bg-background dark:bg-slate-900 border-2 border-duo-swan shadow-[0_4px_0_var(--duo-swan)] space-y-2">
                    ...
                    <div className="font-black text-duo-eel dark:text-white">Aarav</div>
                  </div>
                  <div className="p-5 rounded-2xl bg-background dark:bg-slate-900 border-2 border-duo-swan shadow-[0_4px_0_var(--duo-swan)] space-y-2">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-tighter text-duo-wolf">
                      <Calendar className="w-3 h-3 text-duo-fox" /> Due Date
                    </div>
                    <div className="font-black text-duo-eel dark:text-white">Friday, May 15</div>
                  </div>
                  <div className="col-span-2 p-6 rounded-[2rem] bg-duo-feather border-2 border-duo-feather-shadow shadow-[0_6px_0_var(--duo-feather-shadow)] space-y-2 text-white">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-[11px] font-black uppercase bg-white/20 px-3 py-1 rounded-full border border-white/30">Drafted</div>
                    </div>
                  ...
                  <div className="col-span-2 flex items-center gap-2 px-2">
                    <Tag className="w-4 h-4 text-duo-macaw" />
                    <span className="text-[11px] font-black uppercase tracking-wider text-duo-hare">Memory saved to: Work Projects</span>
                  </div>
                </div>
              </div>

              {/* Floating Badge */}
              <div className="absolute bottom-6 right-6 bg-duo-bee text-duo-eel px-5 py-3 rounded-2xl shadow-[0_4px_0_var(--duo-bee-shadow)] border-2 border-duo-bee-shadow flex items-center gap-3 animate-bounce-subtle">
