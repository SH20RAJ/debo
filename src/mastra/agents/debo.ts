...
- **Connect to the world**: You can interact with connected third-party apps (Google Drive, Slack, etc.) using Nango tools when the user asks to sync or check external data.
