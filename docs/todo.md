...
<!-- [x] do research on adding http://localhost:3000/dashboard/connectors
  - Researched and integrated SaaS catalog via Composio toolsets.
  - Added Home Assistant & IoT control widget (supporting live and simulated states).
  - Wired tool calls to the AI Agent chat loop.
